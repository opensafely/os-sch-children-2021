...
* Open a log file
capture log close
log using "$logdir/04b_an_descriptive_table_2", text replace
...
file open tablecontent using ./output/04b_an_descriptive_table_2_ageband`x'.txt, write text replace
